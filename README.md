...
TwitterClient is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='http://i.imgur.com/PpCqTpw.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
<img src='http://i.imgur.com/v9aCSyB.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
I definitely had a lot of troubles in a lot of places! Search and searchview proved to be very troublesome, but eventually I was able to figure out SOME of the bugs. If i had more time, I would have focused on improving the UI for the profile pages and detailed tweet view. I would also implement a few small bug fixes and put in things like butterknife to improve the overall performance of the app.
